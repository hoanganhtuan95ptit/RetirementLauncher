...
class CallBlockIntroBottomSheet : BaseBottomSheetDialogFragment<BottomSheetUsageStatsPermissionBinding, CallBlockIntroViewModel>() {

    override val viewModel: CallBlockIntroViewModel by viewModels()
...
@Deeplink
class CallBlockIntroDeeplinkHandler : DeeplinkHandler {

    override val deeplink: String = DeepLinks.CALL_BLOCK_INTRO
    ...
    override suspend fun navigate(fragmentActivity: FragmentActivity, deeplink: String, extras: Map<String, Any?>?, sharedElement: Map<String, View>?): Boolean {
        ...
        CallBlockIntroBottomSheet().show(fragmentActivity.supportFragmentManager, CallBlockIntroBottomSheet.TAG)
