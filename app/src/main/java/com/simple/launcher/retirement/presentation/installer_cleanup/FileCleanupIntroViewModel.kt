...
class FileCleanupIntroViewModel : BaseViewModel() {
    ...
    val title: StateFlow<BigText> = combineState(
        ...
        value = resources.getString(R.string.file_cleanup_intro_title)
    ...
    val description: StateFlow<BigText> = combineState(
        ...
        value = resources.getString(R.string.file_cleanup_intro_desc)
            .with(BigForegroundColor(color))
            .withFirst(resources.getString(R.string.file_cleanup_intro_highlight), BigBold, BigForegroundColor(highlightColor))
            .build()
    }
    ...
    val action: StateFlow<ActionState> = combineState(
        ...
        value = buildActionState(
            text = resources.getString(R.string.file_cleanup_intro_action),
            textColor = color,
