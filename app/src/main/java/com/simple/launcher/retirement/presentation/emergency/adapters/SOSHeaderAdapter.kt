...
data class SOSHeaderViewItem(
    ...
    override fun areItemsTheSame(): List<Any> = listOf("SOSHeader")
...
class SOSHeaderAdapter : ViewItemAdapter<SOSHeaderViewItem, ItemSosHeaderBinding>() {
    ...
    override fun createViewBinding(layoutInflater: LayoutInflater, parent: ViewGroup, viewType: Int): ItemSosHeaderBinding {
    ...
    override fun onBindViewHolder(binding: ItemSosHeaderBinding, viewType: Int, position: Int, item: SOSHeaderViewItem, payloads: List<String>) {
