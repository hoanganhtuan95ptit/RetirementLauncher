...
class NotificationRetentionViewModel : BaseViewModel() {

    val title: StateFlow<BigText> = combineState(resources, BigText("")) { resources ->

        val color = resources.textColorPrimary
        value = resources.getString(R.string.notification_block_retention_title)
            .withStyleTitleLarge()
    ...
    val confirmLabel: StateFlow<BigText> = combineState(resources, BigText("")) { resources ->
        ...
        value = resources.getString(R.string.notification_block_confirm)
