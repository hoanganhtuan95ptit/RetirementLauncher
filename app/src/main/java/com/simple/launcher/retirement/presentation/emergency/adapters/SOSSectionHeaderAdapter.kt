...
class SOSSectionHeaderAdapter : ViewItemAdapter<SOSSectionHeaderViewItem, ItemSosSectionHeaderBinding>() {
    ...
    override fun createViewBinding(layoutInflater: LayoutInflater, parent: ViewGroup, viewType: Int): ItemSosSectionHeaderBinding {
        return ItemSosSectionHeaderBinding.inflate(layoutInflater, parent, false)
    }

    override fun onBindViewHolder(binding: ItemSosSectionHeaderBinding, viewType: Int, position: Int, item: SOSSectionHeaderViewItem, payloads: List<String>) {
