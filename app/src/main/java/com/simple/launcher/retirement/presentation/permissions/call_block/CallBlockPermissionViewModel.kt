...
class CallBlockPermissionViewModel : BaseViewModel() {
    ...
    val title: StateFlow<RichText> = combineState(
        ...
        stringMap.getString(R.string.call_block_title)
            .withFirst(stringMap.getString(R.string.call_block_title), ForegroundColor(color), Bold)
    }
    ...
    val description: StateFlow<RichText> = combineState(
        ...
        stringMap.getString(R.string.call_block_desc)
            .withFirst(stringMap.getString(R.string.call_block_desc), ForegroundColor(color))
