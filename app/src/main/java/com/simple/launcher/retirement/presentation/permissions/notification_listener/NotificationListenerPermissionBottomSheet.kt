...
import com.simple.launcher.retirement.databinding.BottomSheetNotificationListenerPermissionBinding
...
class NotificationListenerPermissionBottomSheet :
    BaseBottomSheetDialogFragment<BottomSheetNotificationListenerPermissionBinding, NotificationListenerPermissionViewModel>() {

    override val viewModel: NotificationListenerPermissionViewModel by viewModels()
    ...
    override fun inflateBinding(
        ...
        container: ViewGroup?
    ): BottomSheetNotificationListenerPermissionBinding {

        return BottomSheetNotificationListenerPermissionBinding.inflate(inflater, container, false)
    }
    ...
    companion object {
        ...
        const val TAG = "NotificationListenerPermissionBottomSheet"
    }
}

@Deeplink
class NotificationListenerPermissionDeeplinkHandler : DeeplinkHandler {

    override val deeplink: String = DeepLinks.PERMISSION_NOTIFICATION_LISTENER
    ...
    override suspend fun navigate(
        ...
        NotificationListenerPermissionBottomSheet().show(
            fragmentActivity.supportFragmentManager,
            NotificationListenerPermissionBottomSheet.TAG
        )
