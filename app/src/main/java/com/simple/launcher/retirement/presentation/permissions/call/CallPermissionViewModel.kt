...
class CallPermissionViewModel : BaseViewModel() {
    ...
    val title: StateFlow<BigText> = combineState(
        ...
        value = resources.getString(R.string.call_permission_title)
            .withStyleTitleLarge()
    ...
    val description: StateFlow<BigText> = combineState(
        ...
        value = resources.getString(R.string.call_permission_desc)
            .withStyleTitleMedium()
            .with(BigForegroundColor(color))
            .withFirst(resources.getString(R.string.call_permission_highlight), BigBold, BigForegroundColor(highlightColor))
            .build()
    }
